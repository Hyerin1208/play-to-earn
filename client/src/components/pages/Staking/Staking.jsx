        ...
        await axios
            ...
            .then(async (res) => {
                ...
                if (res.data.stakerId !== null) {
                    ...
                    const result = await StakingTokenContract.methods.stakers(res.data.stakerId).call();
    ...
    useEffect(() => {
        if (StakingTokenContract !== null && account !== null) {
            check.current = setInterval(async () => {
                const result = await StakingTokenContract.methods.userStakeInfo(account).call();
                        ...
                        <ul>
                            ...
                            <li>
                                <button
                                    onClick={async () => {
                                        if (StakingTokenContract !== null) {
                                            console.log(await AmusementArcadeTokenContract.methods.balanceOf(StakingTokenContract._address).call());
                                        }
                                    }}
                                >
                                    TESTBUTTON
