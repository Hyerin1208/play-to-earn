                                                ...
                                                {snake
                                                    ...
                                                    .map((v, i) => {
                                                        return (
                                                            <p key={i}>
                                                                {i + 1}등 :&nbsp;
                                                                {v === undefined ? "없음" : v.snakePoint === null ? "없음" : v.nick}
                                                                &nbsp;
                                                                {v === undefined ? "" : v.snakePoint === null ? "" : v.snakePoint + "점"}
                                                            </p>
                                                        );
                                                    })}
                                                ...
                                                {tetris
                                                    ...
                                                    .map((v, i) => {
                                                        return (
                                                            <p key={i}>
                                                                {i + 1}등 :&nbsp;
                                                                {v === undefined ? "없음" : v.tetrisPoint === null ? "없음" : v.nick}
                                                                &nbsp;
                                                                {v === undefined ? "" : v.tetrisPoint === null ? "" : v.tetrisPoint + "점"}
                                                            </p>
                                                        );
                                                    })}
                                                ...
                                                {puzzle
                                                    ...
                                                    .map((v, i) => {
                                                        return (
                                                            <p key={i}>
                                                                {i + 1}등 :&nbsp;
                                                                {v === undefined ? "없음" : v.puzzlePoint === null ? "없음" : v.nick}
                                                                &nbsp;
                                                                {v === undefined ? "" : v.puzzlePoint === null ? "" : v.puzzlePoint + "점"}
                                                            </p>
                                                        );
                                                    })}
                                                <br />
                                                ...
                                                {mine
                                                    ...
                                                    .map((v, i) => {
                                                        return (
                                                            <p key={i}>
                                                                {i + 1}등 :&nbsp;
                                                                {v === undefined ? "없음" : v.minePoint === null ? "" : v.nick}
                                                                &nbsp;
                                                                {v === undefined ? "" : v.minePoint === null ? "" : v.minePoint + "초"}
                                                            </p>
                                                        );
                                                    })}
                                            </ul>
                                ...
                                <div className={toggleState === 3 ? "content  active-content" : "content"}>
                                    ...
                                    <Container className="my__rank">
                                        <ul>
                                            ...
                                            <li>2048Game</li>
                                            <br />
                                            {puzzleI.puzzlePoint !== null ? puzzleT + 1 + "등" : "없음"}
                                            <br />
                                            <li>TetrisGame</li>
                                            <br />
                                            {tetrisI.tetrisPoint !== null ? tetrisT + 1 + "등" : "없음"}
                                            <br />
                                            <li>MineGame</li>
                                            <br />
