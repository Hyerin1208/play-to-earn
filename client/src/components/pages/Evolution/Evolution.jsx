            ...
            <Row className="row__box">
                <Col md="5">
                    <div className="card__wrapper">
                        <motion.div className="card__container" style={{ x, y, rotateX, rotateY, z: 100 }} drag dragElastic={0.16} dragConstraints={{ top: 0, left: 0, right: 0, bottom: 0 }} whileTap={{ cursor: "grabbing" }}>
                            ...
                            <div className="bottom__container">
                                <EvoDetails data={{ NFTIndex: NFTIndex, NFTId: NFTId, setAfterEvo: setAfterEvo }} />
                                <div className="evolu__details" />
                            </div>
                        </motion.div>
                    </div>
                </Col>
                {EvoProfileModal && <EvoProfile setShowModal={setEvoProfileModal} setBeforeEvo={setBeforeEvo} setNFTIndex={setNFTIndex} setNFTId={setNFTId} setVisible={setVisible} />}
                <Col md="2">
                                ...
                                <div className="nft__content">
                                    <Row>
                                        <h5 className="nft__title">
                                            {afterEvo !== null ? afterEvo.formInput.name : "카드이름"}
                        ...
                        {props.item.formInput.name}
                                        ...
                                        <Col>
                                            ...
                                            <Badge pill bg="light" text="dark" className="rare__badge">
                                                rare :{afterEvo !== null ? afterEvo.formInput.rare : "진화전"}
                                            </Badge>
                                        </Col>
                                        <Col>
                                            ...
                                            <div className="pixel__container">
                                                {[...Array(5)].map((star, i) => {
                                                    ...
                                                    return (
                                                        <label key={i}>
                                                            <input type="radio" className="rating" value={ratingValue} onClick={() => setRating(ratingValue)} />
            ...
            <Container>
                <div className="evo__rules">
                    ...
                    <ul>
                        ...
                        <li>2. Evolution will only change the rarity and stars, other attributes will be inherited (character, talent, skill, potential, training).</li>
