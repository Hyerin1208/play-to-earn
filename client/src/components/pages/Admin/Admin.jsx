        ...
        await axios
            ...
            .then(async (res) => {
                if (res.data.message === "ok") {
                    ...
                    await AmusementArcadeTokenContract.methods.transfer(claimAddress, sendamount).send({ from: account, gas: 3000000 });
                    alert("DB 전송 완료");
                            ...
                            <div className="section1__one">
                                <Col xs="4">
                                    ...
                                    <div className="btn__admin">
                                        <button className="sendRank__btn" type="button" onClick={() => sendRank()}>
                                            Send Ranking
                                        </button>
