        ...
        try {
            ...
            await web3.eth.net
                ...
                .then(async (res) => {
                    ...
                    if (parseInt(givenNetworkId) === parseInt(networkId) && res === true) {
                        ...
                        await axios.post("http://127.0.0.1:5000/user/owner", { address: Owner }).then((res) => {
                            dispatch(
                                connectSuccess({
                                    network: true,
        ...
        try {
            if (Provider !== undefined) {
                ...
                if (parseInt(givenNetworkId) === parseInt(networkId)) {
                    ...
                    const StakingTokenContract = new web3js.eth.Contract(StakingToken_abi, StakingToken_address);
