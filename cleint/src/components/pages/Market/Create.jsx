...
const Create = (props) => {
    const AAT = useSelector((state) => state.AppState.AmusementArcadeTokenContract);
    ...
    async function CreateNFT() {
        ...
        await CreateNFTContract.methods
            ...
            .then(async (res) => {
                ...
                const tokenURI = await CreateNFTContract.methods.tokenURI(parseInt(tokenId)).call();
                            ...
                            <div className="create__input">
                                <form>
                                    <div className="form__input">
                                        ...
                                        <input type="file" name="Asset" className="upload__input" width="350" src={NFTform.fileUrl} onChange={onChange} />
                                        {/* {fileUrl && (
